...
from nuplan.database.common.data_types import RLE, Bbox, CameraIntrinsic, Rotation, Size, Translation, \
    Visibility
...
class SqlVisibility(TypeDecorator):
    ...
    def process_bind_param(self, value: Optional[Visibility], dialect: Dialect) -> str:
        """ Inherited, see superclass. """
        if not value:
