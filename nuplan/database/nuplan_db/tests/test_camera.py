...
class TestCamera(unittest.TestCase):
    ...
    @patch("nuplan.database.nuplan_db.camera.inspect", autospec=True)
    ...
    @patch("nuplan.database.nuplan_db.camera.simple_repr", autospec=True)
    ...
    @patch("nuplan.database.nuplan_db.camera.np.array", autospec=True)
