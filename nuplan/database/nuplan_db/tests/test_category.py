...
class TestCategory(unittest.TestCase):
    ...
    @patch("nuplan.database.nuplan_db.category.inspect", autospec=True)
    ...
    @patch("nuplan.database.nuplan_db.category.simple_repr", autospec=True)
    ...
    @patch("nuplan.database.nuplan_db.category.default_color", autospec=True)
    ...
    @patch("nuplan.database.nuplan_db.category.default_color_np", autospec=True)
