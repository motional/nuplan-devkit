...
class TestTrafficLightStatus(unittest.TestCase):
    ...
    @patch("nuplan.database.nuplan_db.traffic_light_status.simple_repr", autospec=True)
    ...
    @patch("nuplan.database.nuplan_db.traffic_light_status.inspect", autospec=True)
