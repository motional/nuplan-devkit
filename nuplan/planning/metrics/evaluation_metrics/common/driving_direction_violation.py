...
class DrivingDirectionViolationStatistics(MetricBase):
    """Driving direction violation metric.
    This metric traces if ego has been driving aggainst the traffic flow more than some threshold during some time interval of ineterst.
    """
    ...
    def __init__(
        ...
        """
        Initialize the DrivingDirectionViolationStatistics class.
        ...
        :param time_horizon: Movement of the vehicle along baseline direction during a horizon time_horizon is considered for evaluation.
        """
    ...
    def compute(self, history: SimulationHistory, scenario: AbstractScenario) -> List[MetricStatistics]:
        """
        Return the ego progress along the expert route metric.
