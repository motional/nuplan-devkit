...
class EgoAtFaultCollisionBicycleStatistics(ViolationMetricBase):
    """
    Statistics on number and energy of at fault collisions of ego with bicycles.
    ...
    def __init__(
        ...
        """
        Initializes the EgoAtFaultCollisionBicycleStatistics class
    ...
    def compute(self, history: SimulationHistory, scenario: AbstractScenario) -> List[MetricStatistics]:
        ...
        :return: the estimated bicycle collision energy and counts.
        """
