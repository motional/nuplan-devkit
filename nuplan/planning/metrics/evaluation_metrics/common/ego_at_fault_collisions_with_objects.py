...
class EgoAtFaultCollisionObjectStatistics(ViolationMetricBase):
    """
    Statistics on number and energy of at fault collisions of ego with objects.
    ...
    def __init__(
        ...
        """
        Initializes the EgoAtFaultCollisionObjectStatistics class
    ...
    def compute(self, history: SimulationHistory, scenario: AbstractScenario) -> List[MetricStatistics]:
        ...
        :return: the estimated object collision energy and counts.
        """
        ...
        # Create a list of all objects to combine the violation metrics
        object_types = [
