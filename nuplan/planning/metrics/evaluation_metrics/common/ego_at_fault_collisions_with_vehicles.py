...
class EgoAtFaultCollisionVehicleStatistics(ViolationMetricBase):
    """
    Statistics on number and energy of at fault collisions of ego with vehicles.
    ...
    def __init__(
        ...
        """
        Initializes the EgoAtFaultCollisionVehicleStatistics class
    ...
    def compute(self, history: SimulationHistory, scenario: AbstractScenario) -> List[MetricStatistics]:
        ...
        :return: the estimated vehicle collision energy and counts.
        """
