...
from nuplan.planning.metrics.evaluation_metrics.common.ego_at_fault_collisions_with_bicycles import (
    EgoAtFaultCollisionBicycleStatistics,
)
...
@nuplan_test(path='json/ego_at_fault_collision/collisions_with_bicycle.json')
def test_collision_with_bicycle(scene: Dict[str, Any]) -> None:
    """
    Tests there is 1 collision as expected.
    ...
    metric = EgoAtFaultCollisionBicycleStatistics(
        'ego_at_fault_collisions_with_bicycles_statistics',
        'Dynamics',
