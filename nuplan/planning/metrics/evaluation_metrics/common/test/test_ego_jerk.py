...
class TestEgoJerk(unittest.TestCase):
    """ Run ego_jerk unit tests. """

    def setUp(self) -> None:

        self.metric_name = "ego_jerk"
        self.ego_jerk = EgoJerkStatistics(name=self.metric_name, category='Dynamics')
    ...
    def test_metric_name(self) -> None:
        ...
        self.assertEqual(self.ego_jerk.name, self.metric_name)

    def test_compute(self) -> None:
        """ Test compute. """

        results = self.ego_jerk.compute(self.history)
