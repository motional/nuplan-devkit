...
from nuplan.planning.metrics.evaluation_metrics.common.planner_expert_average_heading_error import (
...
@nuplan_test(path='json/planner_expert_average_heading_error/planner_expert_average_heading_error.json')
def test_planner_expert_average_heading_error(scene: Dict[str, Any]) -> None:
    ...
    metric = PlannerExpertAverageHeadingErrorStatistics(
        'planner_expert_average_heading_error',
        'Planning',
