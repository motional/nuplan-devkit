...
from nuplan.planning.metrics.evaluation_metrics.common.planner_expert_final_heading_error import (
...
@nuplan_test(path='json/planner_expert_final_heading_error/planner_expert_final_heading_error.json')
def test_planner_expert_final_heading_error(scene: Dict[str, Any]) -> None:
    ...
    metric = PlannerExpertFinalHeadingErrorStatistics(
        'planner_expert_final_heading_error',
        'Planning',
