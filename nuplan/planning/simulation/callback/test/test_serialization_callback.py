...
class TestSerializationCallback(unittest.TestCase):
    ...
    def test_callback(self) -> None:
        ...
        self.setup = SimulationSetup(
            ...
            scenario=scenario,
            simulation_manager=self.sim_manager,
        ...
        self.assertEqual(str(directory),
                         self.output_folder.name + "/sim/DummyPlanner/mock_scenario_type/mock_scenario_name")
        ...
        state_0 = EgoState.from_raw_params(StateSE2(0, 0, 0),
                                           velocity_2d=StateVector2D(x=0, y=0),
                                           acceleration_2d=StateVector2D(x=0, y=0),
                                           tire_steering_angle=0,
                                           time_point=TimePoint(0))
        state_1 = EgoState.from_raw_params(StateSE2(0, 0, 0),
                                           velocity_2d=StateVector2D(x=0, y=0),
                                           acceleration_2d=StateVector2D(x=0, y=0),
                                           tire_steering_angle=0,
        ...
        path = pathlib.Path(
            ...
            "/sim/DummyPlanner/mock_scenario_type/mock_scenario_name/mock_scenario_name.msgpack.xz")
