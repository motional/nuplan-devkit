...
class IDMPolicyTests(unittest.TestCase):
    ...
    def setUp(self):  # type: ignore
        self.idm = IDMPolicy(target_velocity=30, min_gap_to_lead_agent=2,
                             headway_time=1.5, accel_max=0.73, decel_max=1.67)
    ...
    def test_solve_forward_euler_idm_policy(self):  # type: ignore
        ...
        solution = self.idm.solve_forward_euler_idm_policy(self.agent,
                                                           self.lead_agent, self.sampling_time)
    ...
    def test_non_differential_idm_policy(self):  # type: ignore
        ...
        solution = self.idm.solve_odeint_idm_policy(self.agent,
                                                    self.lead_agent, self.sampling_time, 2)
