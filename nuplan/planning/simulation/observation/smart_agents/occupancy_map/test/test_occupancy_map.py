...
from nuplan.planning.simulation.observation.smart_agents.occupancy_map.geopandas_occupancy_map import GeoPandasOccupancyMapFactory, \
    OccupancyMap
...
class OccupancyMapTests(unittest.TestCase):
    ...
    def test_get_nearest_entry(self):  # type: ignore
        gp_occupancy_map = GeoPandasOccupancyMapFactory.get_from_geometry([self.p2,
                                                                           self.p3,
                                                                           self.p4])  # index 0, 1, 2
        strtree_occupancy_map = GeoPandasOccupancyMapFactory.get_from_geometry([self.p2,
                                                                                self.p3,
                                                                                self.p4])  # index 0, 1, 2
